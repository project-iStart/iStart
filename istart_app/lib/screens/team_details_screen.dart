                ...
                child: RefreshIndicator(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, i) =>
                        _ThreadCard(thread: threads[i], accent: widget.accent),
                  ),
                ),
              ),
              Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, i) {
        ...
        final memberMap = member is Map ? member : {'name': member.toString()};
        final isFounder = i == 0;
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: isFounder ? accent : Colors.white.withOpacity(0.07),
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Center(
                  child: Text(
                    (memberMap['name'] as String?)?.isNotEmpty == true
                        ? (memberMap['name'] as String)[0].toUpperCase()
                        : '?',
                    style: TextStyle(
                      fontFamily: 'Sora',
                      fontSize: 18,
                  ...
                  children: [
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                            memberMap['name'] as String? ?? 'Team Member',
                            style: const TextStyle(
                              fontFamily: 'Sora',
                              fontSize: 14,
                              fontWeight: FontWeight.w600,
